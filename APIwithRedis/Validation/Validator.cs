...
namespace APIwithRedis.Validation
{
    public class Validator : AbstractValidator<PaymentOptions>
    {
        public Validator()
        {
            RuleFor(x => x.Vendor)
                .NotEmpty()
                .Must(v => new[] { VendorEnums.carrier.ToString() , VendorEnums.publisher.ToString() ,VendorEnums.charity.ToString(),VendorEnums.seller.ToString() }.Contains(v))
            ...
            When(x => x.PaymentMethod != null , () =>
            {
                RuleFor(x => x.PaymentMethod)
                    .Must(v => new[] { PaymentMethodEnums.check.ToString(), PaymentMethodEnums.bank_transfer.ToString() }.Contains(v))
            ...
            When(x => x.ProcessingType != null, () =>
            {
                ...
                .Must(v => new[] { ProcessingTypeEnums.manual.ToString(),ProcessingTypeEnums.automated.ToString() }.Contains(v))
            ...
            When(x => x.PaymentSystemName != null, () =>
            {
                ...
                .Must(v => new[] { ProcessorTypesEnums.peddle.ToString(),ProcessorTypesEnums.lob.ToString(),ProcessorTypesEnums.checkbook_io.ToString(),ProcessorTypesEnums.frost.ToString(),ProcessorTypesEnums.peddle_carrier.ToString(),  }.Contains(v))
